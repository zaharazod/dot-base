...
# django dev
alias mbmewatch='inotifywait --csv --recursive --monitor --event modify --include ".*\.(html|py)\$" /srv/mattbarry.me/mbme/ | while read change; do echo \"$? $change\"; sleep 4; echo "reloading"; touch /srv/mattbarry.me/mbme/awa/wsgi.py ; done'
