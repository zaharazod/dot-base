...
# django dev
alias mbmewatch='inotifywait --csv --recursive --monitor --event modify --include .*\.py\$ --include ".*\.(html|py)\$" /home/matt/hack/mbme/ | while read change; do echo \"$? $change\"; sleep 2; touch /srv/mattbarry.me/mbme/mbme/wsgi.py ; done'
# speling
